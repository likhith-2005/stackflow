...
const Qustiondetails = () => {
    ...
    const handlepostans=(e,answerlength)=>{
        e.preventDefault();
        if(user ===null){
            alert("Login or Signup to answer for a question by user")
            navigate('/Auth')
        }else{
            if(answer===""){
                alert("Enter an valid answer before submitting")
            }else{
                    ...
                    <section className='question-details-container'>
                        ...
                        <div className="question-details-container-2">
                            <div className="question-votes">
                                <img src={upvote} alt=""  width={19} className='votes-icon' onClick={handleupvote}/>
                                <p>{question.upvote.length- question.downvote.length}</p>
                                <img src={downvote} alt=""  width={19} className='votes-icon' onClick={handledownvote}/>
                            </div>
                            <div style={{width:"100%"}}>
